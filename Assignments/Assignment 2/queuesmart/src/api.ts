...
import type { Service, ServiceFormInput, Table, TableFormInput, Reservation, ReservationFormInput, MyQueueStatus, WaitlistHistoryRecord, AppNotification } from './contracts/types';
import { mockServices, mockQueueEntries, mockTables, mockReservations, mockMyQueueStatus, mockWaitlistHistory, mockNotifications } from './data/mockData';
...
// Same pattern as everything above: private fetch* wrapping mock
// data with a fake delay, exported as a useX() hook over useQuery.
