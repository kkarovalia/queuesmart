...
import { Clock3, DoorOpen, UsersRound } from 'lucide-react'
import { useQueueLengths, useServices } from '../../api'
...
export function AdminDashboardPage() {
    ...
    return <section className="admin-dashboard page">
        <header className="page-header"><div><h1>Admin Overview</h1><p>Live service and seating operations for QueueSmart.</p></div><Link to="/admin/services/new" className="primary-button">Add service</Link></header>
        ...
        <section className="admin-section panel"><div className="admin-section__header"><div><h2>Active services</h2><p>Open, close, edit, or inspect each queue.</p></div><div><Link to="/admin/history" className="secondary-button">History</Link></div></div>
